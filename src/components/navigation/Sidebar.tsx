...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems: { id: NavigationTab; label: string; icon: React.FC<{ className?: string }>; badge?: string }[] = [
    ...
    { id: 'studio', label: 'Memory Timeline', icon: Layers },
  ];
        ...
        <nav className="space-y-1.5">
          ...
          {onOpenPhotosImport && (
            <button
              ...
              className="w-full mt-3 flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold text-cyan-300 hover:text-white bg-cyan-950/30 hover:bg-cyan-950/60 border border-cyan-500/20 hover:border-cyan-500/50 transition-all group"
            >
      ...
      <div className="space-y-3 pt-4 border-t border-gray-800/60">
        <div className="bg-gray-900/50 border border-gray-800/80 rounded-xl p-3">
          ...
          <p className="text-[11px] text-gray-400 leading-tight">
            Memories stay synced across your mobile and computer.
          </p>
        </div>
